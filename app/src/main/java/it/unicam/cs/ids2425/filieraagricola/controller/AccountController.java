...
public class AccountController {
    ...
    public void creaVenditore(String email, String password, String PIVA, String ragioneFiscale, String descrizione){
        Venditore v = new Venditore(email, password, PIVA, ragioneFiscale, descrizione);
        accService.aggiungiVenditore(v);
    }

    public void modificaVenditore(String precEmail, String email, String password, String PIVA, String ragioneFiscale, String descrizione){
        Venditore v = new Venditore(email, password, PIVA, ragioneFiscale, descrizione);
        //TODO finire
